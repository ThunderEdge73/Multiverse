return {
	...
	misc = {
		...
		dictionary = {
			...
			b_mul_disable_blindexpander = "Disable BlindExpander",
			b_mul_enable_blindexpander = "Enable BlindExpander",
			b_mul_update_blindexpander = "Update BlindExpander",
			b_mul_download_blindexpander = "Download BlindExpander",
			b_mul_continue = "Continue without BlindExpander",
			mul_blindexpander_outdated = {
				"Your version of {C:attention}BlindExpander",
				"seems to be {C:red}outdated{}...",
				"{C:attention}Blinds{} from {C:mul_transmuted}Multiverse{} will",
				"{C:red}not{} function correctly if",
				"{C:attention}BlindExpander{} is {C:red}outdated{}.",
				"{C:inactive}(Minimum required version{}",
				"{C:inactive}of BlindExpander is {C:attention}#1#{C:inactive},{}",
				"{C:inactive}installed version is {C:attention}#2#{C:inactive}){}",
			},
			mul_blindexpander_missing = {
				"It looks like {C:attention}BlindExpander",
				"is currently {C:red}not loaded{}...",
				"{C:mul_transmuted}Multiverse{} has {C:attention}Boss Blinds",
				"and certain features that",
				"depend on {C:attention}BlindExpander{}.",
				"{C:inactive}(Minimum required version{}",
				"{C:inactive}of BlindExpander is {C:attention}#1#{C:inactive},{}",
				"{C:inactive}installed version is {C:attention}#2#{C:inactive}){}",
			},
