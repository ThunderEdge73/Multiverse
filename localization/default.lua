		...
		Other = {
			...
			mul_thaumaturgy_desc = {
				...
				text = {
					...
					"exceeds{s:0.57} {C:mul_transmuted,f:mul_thaum_icon,E:mul_rotate}+{C:mul_transmuted}100{} at end of",
					"round, set Thaumaturgy",
					"Energy to{s:0.57} {C:mul_transmuted,f:mul_thaum_icon,E:mul_rotate}+{C:mul_transmuted}0{} and create",
