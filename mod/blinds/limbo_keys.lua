...
local key_file = assert(SMODS.NFS.newFileData(Multiverse.path .. "assets/misc/limbo_key.png"))
local key_data = assert(love.image.newImageData(key_file))
Multiverse.LIMBO_KEY_SPRITE = assert(love.graphics.newImage(key_data))

local blunder_file = assert(SMODS.NFS.newFileData(Multiverse.path .. "assets/misc/blunder.png"))
...
-- local limbo_instructions_file = assert(SMODS.NFS.newFileData(Multiverse.path .. "assets/misc/limbo_instructions.png"))
